...
export default function HomeScreen() {
  ...
  const styles = StyleSheet.create({
    container: {
      ...
      backgroundColor: 'white', // Jaune crème très clair
    },
    profilePic: {
      width: 40,
      height: 35,
    ...
    nextCard: {
      backgroundColor: '#FFE0B2', // Orange pêche clair
      padding: 18,
      borderRadius: 10,
      marginBottom: 30,
      shadowColor: '#000',
    ...
    event: {
      backgroundColor: 'white', // Beige très clair
      padding: 14,
      marginBottom: 12,
      borderRadius: 10,
      borderLeftWidth: 5,
      borderLeftColor: '#FFB300', // Jaune-orangé
    },
    eventTitle: {
      fontSize: 16,
      fontWeight: '600',
    ...
    progressContainer: {
      height: 14,
      backgroundColor: '#FFE0B2', // fond barre clair
      borderRadius: 8,
      overflow: 'hidden',
      marginTop: 20,
    },
    progressBar: {
      height: '100%',
      borderRadius: 8,
      backgroundColor: '#FFB300', // Jaune-orangé
    },
    progressText: {
      marginTop: 8,
      textAlign: 'center',
      fontSize: 14,
      color: '#6B4F00', // brun foncé
      marginBottom: 8,
    },
    sleepImage: {
      width: '100%',
      ...
      {nextCountdown && countdownDays !== null && (
        <View style={{ marginBottom: 20 }}>
          <Text style={{ fontSize: 16, color: '#333' }}>
            🎯 Plus que <Text style={{ fontWeight: 'bold', color: '#E53935' }}>{countdownDays} jours</Text> avec {nextCountdown.title}
          </Text>
        </View>
      )}
